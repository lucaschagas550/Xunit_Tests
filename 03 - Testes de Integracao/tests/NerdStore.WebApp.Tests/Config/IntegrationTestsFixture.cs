...
namespace NerdStore.WebApp.Tests.Config
{
    ...
    public class IntegrationTestsFixture<TStartup> : IDisposable where TStartup : class
    {
        ...
        public IntegrationTestsFixture()
        {
            ...
            //Consegue subir servidor para executar os testes mvc, como fixture mantem o estado ganha um bom desempenho nos testes, subindo apenas 1 servidor sem precisar recriar
